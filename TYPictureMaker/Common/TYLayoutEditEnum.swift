...
enum TYLayoutEditEnum: Int, CaseIterable {
    case vertical = 0, horizontal, view21, view22, view23, view24, view24_1, view25, view26, view27, view28, view29
    ...
    func toEditView(images: [UIImage]?) -> TYBaseEditView {
        ...
        case .view27:
            ...
            view = v
        case .view28:
            let  v = TYLayoutView28(images: images)
            view = v
        case .view29:
            let  v = TYLayoutView29(images: images)
            view = v
        }
